...
![topologi](./img/dns-slave-topology.svg)
...
Opsi `also-notify` digunakan untuk memberi pemeberitahuan pada server <code>{v.SERVER_2_NAME}</code> jika terdapat perubahan atau pembaruan berkas zona pada server DNS master.
:::
